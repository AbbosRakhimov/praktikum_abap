...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Assoc_Category_ProductSet'                         "#EC NOTEXT
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Assoc_Product_Images' "#EC NOTEXT
                            iv_left_type        = 'Product' "#EC NOTEXT
                            iv_right_type       = 'Product_Image' "#EC NOTEXT
                            iv_right_card       = 'M' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - Assoc_Product_Images
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'Productid'   iv_dependent_property = 'Productid' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Assoc_Product_ImagesSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'ProductSet'              "#EC NOTEXT
                                              iv_right_entity_set_name = 'Product_ImageSet'             "#EC NOTEXT
                                              iv_association_name      = 'Assoc_Product_Images' ).                                 "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ToCategory' "#EC NOTEXT
                                                              ...
                                                              iv_association_name = 'Assoc_Category_Product' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'ToImages' "#EC NOTEXT
                                                              iv_abap_fieldname = 'TOIMAGES' "#EC NOTEXT
                                                              iv_association_name = 'Assoc_Product_Images' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230111114336'.                  "#EC NOTEXT
