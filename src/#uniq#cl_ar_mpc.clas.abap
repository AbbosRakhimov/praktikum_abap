class /UNIQ/CL_AR_MPC definition
  public
...
public section.
  ...
  types:
TT_BLUBB type standard table of TS_BLUBB .
  types:
  ...
  types:
     TS_KOSTENSTELLE type /UNIQ/KOSTL_S .
  types:
TT_KOSTENSTELLE type standard table of TS_KOSTENSTELLE .

  constants GC_BLUBB type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Blubb' ##NO_TEXT.
  constants GC_KOSTENSTELLE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Kostenstelle' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_BLUBB
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_KOSTENSTELLE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS /UNIQ/CL_AR_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'UNIQ.AR_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Blubb' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = '/UNIQ/CL_AR_MPC=>TS_BLUBB' ). "#EC NOTEXT
  endmethod.


  method DEFINE_KOSTENSTELLE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Kostenstelle' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'Kosar' iv_abap_fieldname = 'KOSAR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'KosarKtext' iv_abap_fieldname = 'KOSAR_KTEXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Verak' iv_abap_fieldname = 'VERAK' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 20 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Kokrs' iv_abap_fieldname = 'KOKRS' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 4 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Mctxt' iv_abap_fieldname = 'MCTXT' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name   = '/UNIQ/KOSTL_S'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'KostenstelleSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20221107103141'.                  "#EC NOTEXT
