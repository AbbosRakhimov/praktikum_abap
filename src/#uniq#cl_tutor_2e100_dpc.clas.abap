class /UNIQ/CL_TUTOR_2E100_DPC definition
  public
...
protected section.
  ...
  methods SALESORDERITEMSE_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type /UNIQ/CL_TUTOR_2E100_MPC=>TS_SALESORDERITEM
    raising
  ...
  methods SALESORDERITEMSE_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type /UNIQ/CL_TUTOR_2E100_MPC=>TT_SALESORDERITEM
  ...
  methods SALESORDERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type /UNIQ/CL_TUTOR_2E100_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type /UNIQ/CL_TUTOR_2E100_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS /UNIQ/CL_TUTOR_2E100_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 03.11.2022 09:20:55 in client 800
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - /UNIQ/CL_TUTOR_2E100_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorderset_create_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorder.
 DATA salesorderitemse_create_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorderitem.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_get_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorder.
 DATA salesorderitemse_get_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorderitem.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - /UNIQ/CL_TUTOR_2E100_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorderset_get_entityset TYPE /uniq/cl_tutor_2e100_mpc=>tt_salesorder.
 DATA salesorderitemse_get_entityset TYPE /uniq/cl_tutor_2e100_mpc=>tt_salesorderitem.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorderset_update_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorder.
 DATA salesorderitemse_update_entity TYPE /uniq/cl_tutor_2e100_mpc=>ts_salesorderitem.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
